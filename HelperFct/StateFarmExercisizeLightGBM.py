...
HO = pd.read_csv('C:/Users/szreb/Documents/CodeSandBox/StateFarmExercisize/Data/HoldOut.csv',
                 sep = '|')
...
Training[['PredictGBM']].to_csv('C:/Users/szreb/Documents/CodeSandBox/StateFarmExercisize/Data/FinalScores/TrainGBM.csv',
                                index = False)

HOX[['PredictGBM']].to_csv('C:/Users/szreb/Documents/CodeSandBox/StateFarmExercisize/Data/FinalScores/HOGBM.csv',
                                index = False)
